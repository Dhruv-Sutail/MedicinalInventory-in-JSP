<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    pageEncoding="ISO-8859-1" import="java.sql.*,java.util.*,Retailer.*"%>
                                    ...
                                    <table class="table">
                                        <thead>
                                            ...
                                            try{
                                                ...
                                                String sql ="select * from retailer_inventory where uname=?";
                                    	        ...
                                    	        ResultSet resultSet=ps.executeQuery();
                                    	        		while(resultSet.next()){
                                    	        			%>
                                    	        			<tr>
                                    	        			<td><%=resultSet.getString("firm_name") %></td>
                                    	        			<td><%=resultSet.getString("med_name") %></td>
                                    	        			<td><%=resultSet.getString("med_type") %></td>
