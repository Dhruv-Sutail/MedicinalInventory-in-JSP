                                    ...
                                    <table class="table">
                                        <thead>
                                            <tr>
                                                ...
                                                <th scope="col">Medicine Required</th>
                                                <th scope="col">Feedback</th>
                                            </tr>
                                            <%  
												List<feedback> list=feedback_function.getAllRecords();  
                                        ...
                                        <tbody>
											...
											<tr><td>${u.getFirm_name()}</td>  
												<td>${u.getMed_requirement()}</td><td>${u.getFeedback()}</td> 
												<td><a href="man_feed.jsp?id=${u.getId()}"><button type="button" class="btn btn-primary">Send Request</button></a></td> 
												</tr>  
											</c:forEach>  
                                        </tbody>
                                    </table>
