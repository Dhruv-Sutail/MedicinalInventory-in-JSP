                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
											...
											<tr><td>${u.getMed_name()}</td>  
												...
												<td>${u.getPrice()}</td>
												<td><a href="upmed.jsp?id=${u.getId()}"><button type="button" class="btn btn-warning">Update</button></a></td>  
												<td><a href="delmed.jsp?id=${u.getId()}"><button type="button" class="btn btn-danger">Delete</button></a></td>
												</tr>  
											</c:forEach>  
                                        </tbody>
                                    </table>
