...
<body>
    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5" data-sidebartype="full"
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="p-15 m-t-10"><a href="Index_retailer.jsp"
                                class="btn btn-block create-btn text-white no-block d-flex align-items-center"><i
                                    class="fa fa-plus-square"></i> <span class="hide-menu m-l-5">Add Medicine</span> </a>
                        </li>
                        <!-- User Profile-->
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="Feedback.jsp" aria-expanded="false"><i class="mdi mdi-view-dashboard"></i><span
                                    class="hide-menu">Request & FeedBack </span></a></li>
                       
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="inventory_retailer.jsp" aria-expanded="false"><i class="mdi mdi-border-all"></i><span
        ...
        <div class="page-wrapper">
            ...
            <!-- ============================================================== -->
			<div>
					<form action="retailermed.jsp">
					
						<div class="form-group  ml-5  mr-5 ">
						  <label> Firm Name</label>
						  <input type="text" class="form-control" name="firm_name" id="inputEmail4" placeholder=" Enter the Firm Name">
						  </div>
					  
						<div class="form-group  ml-5  mr-5 ">
						  <label> Medicine Type</label>
						  <select class="form-control" name="med_type" id="inputEmail4">
						  	<option value="">Select Medicine Type</option>
						  	 <%
                    			Statement st1 = con.createStatement();
                    			ResultSet rs1 = st1.executeQuery("select distinct med_type from medicine");
                   				while(rs1.next())
        						{
        							String mtype = rs1.getString("med_type");
        						%>	
						...
						<div class="form-group ml-5 mr-5 ">
						  ...
						  <select class="form-control" name="med_name" id="inputEmail4">
						  	<option value="">Select Medicine Name</option>
						  	 <%
                    			Statement st2 = con.createStatement();
                    			ResultSet rs2 = st2.executeQuery("select distinct med_name from medicine");
                   				while(rs2.next())
        						{
        							String mname = rs2.getString("med_name");
        						%>	
					  ...
					  <div class="form-group ml-5  mr-5 ">
						...
						<input type="text" class="form-control" name="quantity" id="inputAddress" placeholder=" Enter the quantity">
					  </div>
