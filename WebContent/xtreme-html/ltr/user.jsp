<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    pageEncoding="ISO-8859-1" import="java.sql.*,java.util.*,User.*"%>
                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        <thead>
                                            ...
                                            <%  
												List<User_details> list=User_store.getAllRecords();  
                                        ...
                                        <tbody>
											...
											<tr><td>${u.getUname()}</td>  
												<td>${u.getEmail()}</td><td>${u.getCategory()}</td>  
												<td><a href="update.jsp?id=${u.getId()}"><button type="button" class="btn btn-primary">Update</button></a></td></tr>  
											</c:forEach>  
                                        </tbody>
                                    </table>
                                </div>
