...
<body>
    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5" data-sidebartype="full"
        ...
        <div class="page-wrapper">
            ...
            <!-- ============================================================== -->
			<div>
					<form action="addmed.jsp">
					  
						<div class="form-group  ml-5  mr-5 ">
						  <label> Medicine Name</label>
						  <input type="text" class="form-control" name="med_name" id="inputEmail4" placeholder=" Enter the Medicine Name">
						  </div>
						<div class="form-group ml-5 mr-5 ">
						  <label>Medicine Type</label>
						  <input type="text" class="form-control" name="med_type" id="inputPassword4" placeholder=" Enter the Medicine Type">
						</div>
					  ...
					  <div class="form-group ml-5   mr-5">
						<label>Price</label>
						<input type="text" class="form-control" name="price" id="inputAddress2" placeholder="Enter the price">
					  </div>
