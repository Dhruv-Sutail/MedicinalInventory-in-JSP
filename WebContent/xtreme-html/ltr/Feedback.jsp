			...
			<div>
					<form action="feed.jsp">
						...
						<div class="form-group ml-5 mr-5 ">
						  ...
						  <input type="textbox" class="form-control" name="med_requirement" id="inputPassword4" placeholder=" Enter the Medicine Required">
						</div>
					  
					  <div class="form-group ml-5  mr-5 ">
						<label> FeedBack</label>
						<input type="textbox" class="form-control" name="feedback" id="inputAddress" placeholder=" Enter the Feedback">
					  </div>
