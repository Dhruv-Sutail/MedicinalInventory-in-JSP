        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb">
                <div class="row align-items-center">
                    <div class="col-5">
                        <h4 class="page-title">Medicine Add</h4>
            ...
            <%  
				...
				med_store u=med_function.getRecordById(Integer.parseInt(id1));
			...
			<div>
					<form action="updatemed.jsp">
						...
						<div class="form-group  ml-5  mr-5 ">
						  <input type="hidden" class="form-control" name="id" id="inputEmail4" value="<%= u.getId()%>">
						  </div>
						  
						<div class="form-group  ml-5  mr-5 ">
						  <label> Medicine Name</label>
						  <input type="text" class="form-control" name="med_name" id="inputEmail4" value="<%= u.getMed_name()%>">
						  </div>
						<div class="form-group ml-5 mr-5 ">
						  <label>Medicine Type</label>
						  <input type="text" class="form-control" name="med_type" id="inputPassword4" value="<%= u.getMed_type()%>">
						</div>
					  
					  <div class="form-group ml-5  mr-5 ">
						<label> Quantity</label>
						<input type="text" class="form-control" name="quantity" id="inputAddress" value="<%= u.getQuantity()%>">
					  </div>
					  <div class="form-group ml-5   mr-5">
						<label>Price</label>
						<input type="text" class="form-control" name="price" id="inputAddress2" value="<%= u.getPrice()%>">
					  </div>
